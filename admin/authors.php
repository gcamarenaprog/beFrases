...
<div class="container-fluid">
  ...
  <p class="lead">En esta sección podrás añadir, editar o eliminar categorías, para editar o eliminar selecciona una
    categoría de la lista.</p>
    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
      ...
      <form method="post" class="mb-3" style="display: block;" id="iFormAddAuthor" name="nFormAddAuthor">
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" name="nTextAreaAuthorDescription" id="iTextAreaAuthorDescription"
                    placeholder="Descripción.." rows="3" required></textarea>
          <div id="iHelpAuthorDescription" class="form-text">La descripción no se muestra por defecto; sin embargo, hay
            algunos temas y opciones que pueden mostrarla.
          </div>
        </div>
      ...
      <form method="post" class="mb-3" style="display: none;" id="iFormEditAuthor" name="nFormEditAuthor">
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" name="nTextAreaEditAuthorDescription" id="iTextAreaEditAuthorDescription"
                    rows="3"></textarea>
          <div id="iHelpAuthorDescription" class="form-text">La descripción no se muestra por defecto; sin embargo, hay
            algunos temas y opciones que pueden mostrarla.
          </div>
        ...
        <button type="submit" name="nButtonSaveEditAuthor" id="iButtonSaveEditAuthor" class="btn btn-dark">Guardar
          cambios
        </button>
        <button type="button" name="nButtonCancelEditAuthor" id="iButtonCancelEditAuthor" class="btn btn-dark"
        ...
        <div id="iCardDeleteMessageYes" name="nCardDeleteMessageYes" class="card text-center">
          ...
          <div class="card-body">
            ...
            <div class="row justify-content-center">
              <div class="col-4">
                <button type="button" name="nButtonAcceptDeleteAuthor" id="iButtonAcceptDeleteAuthor"
                        class="btn btn-dark" style="display: none;" onclick="hiddeFormDeleteAuthor()">Aceptar
                </button>
              </div>
            </div>
            ...
            <div class="row justify-content-center">
              <div class="col-4">
                <button type="submit" name="nButtonDeleteAuthor" id="iButtonDeleteAuthor" class="btn btn-dark"
                        style="display: none;">Eliminar
                </button>
              </div>
              <div class="col-4">
                <button type="button" name="nButtonCancelDeleteAuthor" id="iButtonCancelDeleteAuthor"
                        class="btn btn-dark" style="display: none;" onclick="hiddeFormDeleteAuthor()">Cancelar
                </button>
              </div>
            </div>
          ...
          <?php
            foreach ($categoriesList as $key => $value) {
              ...
              <td style="text-align:center">
                <button class="btn btn-success" id="iButtonEditAuthorRegister" name="nButtonEditAuthorRegister"
              ...
              <td style="text-align:center">
                <button class="btn btn-danger" id="iButtonDeleteAuthorRegister" name="nButtonDeleteAuthorRegister"
