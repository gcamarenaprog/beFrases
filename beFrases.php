...
/**
 * Add option to the Wordpress add menu
 *
 * @since  1.0.0
 * @access public
 */
function add_quote_menu_item($wp_admin_bar)
{
  ...
  $args = array(
    'id'        => 'quote',
    'title'     => 'Quote',
    'href'      => get_admin_url() . 'admin.php?page=beFrases%2Fadmin%2Fmanage.php',
    'parent'    => 'new-content'
  );
